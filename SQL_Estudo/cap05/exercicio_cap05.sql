# Supondo que a comissao de cada vendedor seja de 10%, quanto cada vendedor ganhou de comissao nas vendas no estado do ceara?
...
SELECT 
	...
	CASE 
		...
		END AS total,
    CASE 
		WHEN estado_cliente IS NULL THEN 'Fora de CE'
			ELSE estado_cliente
